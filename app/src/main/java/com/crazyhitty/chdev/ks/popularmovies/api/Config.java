...
public class Config {
    ...
    public static final String DISCOVER_MOVIES_API_POPULARITY = "http://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=";
    ...
    public static final String DISCOVER_MOVIES_API_USER_RATING = "http://api.themoviedb.org/3/discover/movie?sort_by=vote_average.desc&api_key=";

    //DONOT MODIFY THIS
    public static final String MOVIE_API = "http://api.themoviedb.org/3/movie/";
